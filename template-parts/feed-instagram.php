<?php
/*
📍 Requiere el plugin: instagram-feed (https://es-ar.wordpress.org/plugins/instagram-feed/)

Fields Back Office: Configuracion
ACF: core/acf/options-settings.php (group_feed_instagram)
*/
